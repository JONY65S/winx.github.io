    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                <p class="Tema">Ponencia a evaluar</p>
                <form name="first" method="post" id='forms1' action="evaResFP.php">
                                    ...
                                    <td class="C4">
                                        <p align="left">Trabajo: 
                                            <select name="workUser" onchange='submitForm();'>
                                                ...
                                                <?php
                                                $query=("SELECT * FROM trabajos, evaluacion_trabajos, evaluacion, ponencia WHERE trabajos.id_trabajo=evaluacion_trabajos.trabajos_id and evaluacion_trabajos.evaluacion_id=evaluacion.id_evaluacion and ponencia.id_trabajos=trabajos.id_trabajo and evaluacion_trabajos.estado='POR EVALUAR' and resumen_ponencia LIKE '%' and video_url IS NULL and extenso_doc IS NULL and usuario_id='$varId'");
                                                $result=pg_query($conexion, $query);
                                                while ($row=pg_fetch_array($result)){
                                                echo '<option value="'.$row['id_trabajo'].'">'.$row['titulo'].'</option>';   
                                                }
                ...
                <div>
                    <center>
                        <button type="submit" onclick="window.location.href = 'evaMain.php'">Atras</button>
