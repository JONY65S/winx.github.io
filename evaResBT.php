...
<?php
   ...
   $query06=("select * from ponente_trabajos, usuario where ponente_id=id_usuario and trabajos_id='$workId'");
    ...
    if($aspE0 == $Comp and $aspE1 == $Comp and $aspE2 == $Comp and $aspE3 == $Comp){
        ...
        class PDF extends FPDF
        {
            ...
            function Header() 
            {
                ...
                $this->Text(10,95,utf8_decode('Tenemos el agrado de comunicarle (s) que su Resumen del Taller:'));
                ...
                $this->Text(10,130,utf8_decode('1 - Consultar los lineamientos de presentación del taller.'));
                $this->Text(10,135,utf8_decode('https://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/.WinxCongreso/index.php'));
                $this->Text(10,140,utf8_decode('2 - Subir su contenido y materiales en el apartado Historial de trabajos.'));
                $this->Text(10,145,utf8_decode('3 - Por favor estar atento al cronograma del evento.'));
                $this->Text(10,150,utf8_decode('4 - Realizar el pago correspondiente.'));
    ...
    $filePdf = $file;
    $pdfName = "TR_" . $workId . $fechaid . ".pdf";
