...
//Query que actualiza la tabla, agregando el dato de video y extenso
 $idtt=$_GET['itt'];
$query2 = ("UPDATE ponencia SET video_url = '$url' WHERE id_trabajos = '$idtt'"); //el numerito es el id de una ponencia
...
$queryA4 = ("INSERT INTO evaluacion_video   values ('$numid')");
...
Su URL del video de ponencia {$titul} ha sido registrada con éxito.";
...
<html lang="es">
    <head>
        ...
        <title>Registro de Video para Ponencia</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de URL de Video para Ponencia</p>
...
<div class="D1">
  ...
  <table>
                         <td class="C1">
                                   ...
                                   <br><br><br> <label for="URL">URL:</label> 
                                </td>
                                <td class="C2">
                          <br><p class="temaSec">1.- Ingrese el link de su video, el cual debió haber subido en Google 
                          Drive.</p> 
                                	<textarea class="textarea2"  type="text"  name="url" placeholder="INGRESA URL DEL VIDEO" required></textarea>
                                </td>
                                                    </tr> </center>
             ...
             <br><button class="enviarBtn" type="submit" name="subir" value="Cargar archivo">Enviar video</button><br>
             </div>
</div></form>
