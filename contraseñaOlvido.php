...
<div class="ContenedorPrincipal"> 
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    ...
    <p class="Tema">Recuerar Contraseña</p>
    ...
    <div class="datosP" >
      ...
      <div class="D1">
        <table>
          <center>
            <tr>
             <p class="temaSec">Genera una Nueva Contraseña. Introducir sus datos correctos, ya que con ellos podra acceder futuramente al sistema.</p>
            </tr>
          </center>
        </table>
      </div>
      
      <p class="temaCentral">Usuario</p>
        ...
        <tr>
          <td class="C1">
            <label for="Password">Ingresa tu Correo:</label>
          </td>
          <td class="C2">
          <input class="inputP" type="email" name="usuario" placeholder="Ingresa Correo" required>
          </td>
        </tr>
      </center>
...
<center>
              <button name="enviarBtn"class="enviarBtn" value="Cambiar contraseña">Restablecer contraseña</button></center>
      </form> </div>
       
      <br> <br>
     <a  href="index3.php"  > <button >Regresar</button> </a>
       </div>
  </div>
</div>
</div>
...
$idc2= $varId ;
    ...
    $enviarCorreo = false;
    if (isset($_POST["usuario"])&& isset($_POST["contraseña2"])&& isset($_POST["contraseña3"])) {
      ...
      if($contraseña3 == $contraseña2){
        ...
        $query="UPDATE usuario SET contraseña='$contraseña33' WHERE usuario='$correo' ";
...
Su contraseña fue cambiada con éxito, su Usuario para acceder al sistema es:{$correo} y su nueva Contraseña es: {$contraseñaSinHash}";

sendEmail($correo, $subject, $body);
                            echo "<script languaje='JavaScript'> 
                    alert('Los datos se actualizaron correctamente');
                    window.location.replace('https://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/.WinxCongreso/InicioSesion.php');
                    </script>";
                  }
