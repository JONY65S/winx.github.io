    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                ...
                <form method="post" action="evaTarB.php">
                   <?php
                        ...
                        $queryResumen=$queryNew2["contenido"];
                                        
                        $query3=("select * from talleres_material, materiales, talleres where id_material=material_id and taller_id=id_trabajos and id_trabajos='$workUserId'");
                        $consulta3=pg_query($conexion,$query3);
                        $queryNew3=pg_fetch_array($consulta3);
                        $queryReferencia=$queryNew3["nombre_material"];   
                        ...
                        $query5=("INSERT INTO evaluacion_taller (evaluacion_id) VALUES ('$queryEvaId')");
                        $consulta5=pg_query($conexion,$query5);
                    
                        $query85=("select * from evaluacion_taller where evaluacion_id=$queryEvaId");
                    ...
                    <div class="datosP">
                        <div class="D1">
                            <table>
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">3. Materiales </label>
                                    </td>
                                    <td class="C5">
                            ...
                            <table>
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="C2">
                                        <textarea class="textarea4" type="text" style="text-transform:uppercase;" name="aspEva3"></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
