...
<?php
    ...
    $aspE6 = $_POST['aspEva6'];
    $aspE7 = $_POST['aspEva7'];
    $queryC0=("UPDATE evaluacion_cartel SET encabezado='$aspE0', introduccion='$aspE1', metodologia='$aspE2', resultados='$aspE3', conclusiones='$aspE4', imagenes='$aspE5', cartel_pdf='$aspE6', observaciones='$aspE7' WHERE evaluacion_id='$evaId'");
    ...
    if($aspE0 == $Comp and $aspE1 == $Comp and $aspE2 == $Comp and $aspE3 == $Comp and $aspE4 == $Comp and $aspE5 == $Comp and $aspE6 == $Comp){
        ...
        class PDF extends FPDF
        {
            ...
            function Header() 
            {
                ...
                $this->Text(10,95,utf8_decode('Tenemos el agrado de comunicarle (s) que su Cartel:'));
                ...
                $this->Text(10,140,utf8_decode('2 - Crear un vídeo de exposición del cartel máximo de 5 minutos en formato mp4.'));
    ...
    $filePdf = $file;
    $pdfName = "IC_" . $workId . $fechaid . ".pdf";
...
<script>
    ...
    alert("EL CARTEL " + varTit + " A SIDO " + varFin + " ¡GRACIAS POR EVALUAR!");
</script>