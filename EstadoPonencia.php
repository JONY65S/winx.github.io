...
<div class="contenedorPrincipal"> 
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    <div class="col-lg-6 mx-auto"> 
      <!--<form  method="post"> -->
     <p class="Tema">Estado de Ponencia</p>  <form action="#" method="POST" >
     <div class="D1">  
     <?php
               ...
               <tr>                                         
                ...
                <td >
                  <?php
                         ...
                         ?> 
                               <a href="corregirponencia.php?itt=<?php echo $rowDataEvaResP3["trabajos_id"];?>">
                 ...
                 <br> <br> <br>
                   ...
                   $querycondi = ("Select * from ponencia WHERE id_trabajos='$id_pon'");
                  ...
                  if (pg_num_rows($conncondi) > 0) {
                    ...
                    $condi2= $rowDatacondi["extenso_doc"];
                       ...
                       <a href="registroextenso.php?itt=<?php echo $rowDataEvaResP3["trabajos_id"];?>">
                        
                  <button type="button" >Enviar Extenso</button> </a> 
                    <?php
                             }}
                  ?>
               </td>
         ...
         <p class="temaCentral">Extenso </p>
            ...
            <?php
              ...
              ?>
               ...
               <tr>                                         
								<td class="C1">
									<label >Estado Actual de Evaluación del Extenso:</label>
								</td>
								<td class="C2">
                ...
                <td >
                  <?php
                         ...
                         ?> 
                               <a href="corregirextenso.php?itt=<?php echo $rowDataEvaExP3["trabajos_id"];?>">
                        
                  <button type="button" >Corregir Extenso</button> </a>
                 <br> <br> <br>
                ...
                $condi3= $rowDatacondi["video_url"];}}
                       ...
                       <a href="registrourlponencia.php?itt=<?php echo $rowDataEvaExP3["trabajos_id"];?>">
              ...
              ?>
               ...
               <tr>                                         
                ...
                <?php
                         ...
                         ?> 
                              <a href="corregirurlponencia.php?itt=<?php echo $rowDataEvaVP3["trabajos_id"];?>">
