                ...
                <td class="C1">
                  ...
                  if (pg_num_rows($connE1) > 0) {
                   ...
                   //Evalua cual de ellos es evaluador
                    $queryE2 = ("Select * from permisos where usuario_id ='$ideval' and permiso_id_rol='2' and estado='true'");
         ...
         <h1 class="Tema">Datos de evaluadores disponibles</h1>
            ...
            <?php $queryE4 = ("Select * from usuario ");
                  ...
                  if (pg_num_rows($connE4) > 0) {
                   ...
                   //Evalua cual de ellos es evaluador
 $queryE3 = ("Select * from permisos where usuario_id ='$ideval4' and permiso_id_rol='2' and estado='true'");
...
<td class="inputNombreC2"><textarea name="textareaa3" rows="mx-auto" cols="mx-auto" class="sinborde"readonly > <?php echo $apellidoE ?> </textarea></td> 
 ...
 $queryA2 = ("INSERT INTO evaluacion (fecha, usuario_id, id_evaluacion) VALUES ('$fechaActual','$idusuarioA1','$numid')");
                  $connA2 = pg_query($conexion, $queryA2);
     if (!$connA2) {
                    die(pg_error($conexion));
                  }else{

$queryA3 = ("INSERT INTO  evaluacion_trabajos values('$numid','$id','$fechaActual','POR EVALUAR')");
                  $connA3 = pg_query($conexion, $queryA3);


$queryA4 = ("INSERT INTO  evaluacion_resumen values('$numid')");
...
$titul = $titulo;
$email = $idcorr;
$pagina = "http://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/.WinxCongreso/index3.php";
$subject = "Asignacion de trabajo a evaluar";

//Cuerpo del correo 
$body = "Congreso Internacional sobre la Enseñanza y Aplicación de las Matemáticas 
Facultad de Estudios Superiores Cuautitlán

Se le ha asignado el trabajo {$titul} para evaluar, ingrese al sitio web del congreso para ver los detalles. {$pagina} {$quienEval} ";
