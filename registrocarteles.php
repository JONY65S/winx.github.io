 ...
 $queryc13=("Select * from congreso ");
                            $connc6=pg_query($conexion,$queryc13);
                               ...
                               if (pg_num_rows($connc6) > 0) {
                                       ...
                                       $nponencia=intval($rowData["num_carteles"]);
   ...
   $queryC1=("Select * from ponente_trabajos where ponente_id='$varId'");
                            ...
                            $connC2=pg_query($conexion,$queryC2);
                                        ...
                                        //contador de trabajos por congreso actual
                                           ...
                                           $queryP1=("Select * from carteles where id_trabajos='$idt2'");
...
<html lang="es">
    <head>
        ...
        <title>Registro de resumen cartel</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de resumen para cartel</p>
...
Su resumen de cartel {$titul} ha sido registrado con éxito.";
