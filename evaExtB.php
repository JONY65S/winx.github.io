<meta HTTP-EQUIV="REFRESH" CONTENT="0;URL=evaExt.php">
<?php
    ...
    $aspE6 = $_POST['aspEva6'];
    $aspE7 = $_POST['aspEva7'];
    $queryC0=("UPDATE evaluacion_extenso SET plantilla='$aspE0', formato='$aspE1', orden='$aspE2', referencias_apa='$aspE3', referencias_cit='$aspE4', redaccion='$aspE5', presentacion='$aspE6', observaciones='$aspE7' where evaluacion_id='$evaId'");
    ...
    if($aspE0 == $Comp and $aspE1 == $Comp and $aspE2 == $Comp and $aspE3 == $Comp and $aspE4 == $Comp and $aspE5 == $Comp and $aspE6 == $Comp){
        $Final = 'AUTORIZADA'; 
        ...
        class PDF extends FPDF
        {
            ...
            function Header() 
            {
                ...
                $this->Text(10,95,utf8_decode('Tenemos el agrado de comunicarle (s) que su Extenso:'));
                ...
                $this->Text(10,140,utf8_decode('2 - Crear un vídeo de exposición del extenso máximo de 5 minutos en formato mp4.'));
                $this->Text(10,145,utf8_decode('3 - Subir su video en el apartado Historial de trabajos.'));
                $this->Text(10,150,utf8_decode('4 - Por favor estar atento al cronograma del evento.'));
    ...
    $filePdf = $file;
    $pdfName = "EP_" . $workId . $fechaid . ".pdf";
...
<script>
    ...
    alert("EL EXTENSO " + varTit + " A SIDO " + varFin + " ¡GRACIAS POR EVALUAR!");
</script>