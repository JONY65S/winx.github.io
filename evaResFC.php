    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                ...
                <form method="post" action="evaResBC.php">
                   <?php
                        ...
                        $query4=("select * from  evaluacion, evaluacion_trabajos, trabajos,carteles where evaluacion.id_evaluacion=evaluacion_trabajos.evaluacion_id and evaluacion_trabajos.trabajos_id=trabajos.id_trabajo and trabajos.id_trabajo=carteles.id_trabajos and evaluacion_trabajos.estado='POR EVALUAR' and trabajos_id='$workUserId';");
