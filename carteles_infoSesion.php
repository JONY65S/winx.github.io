...
<main>
     ...
     <div class="photo">
    <center>
  <img src="img/carteless.jpg" alt="Photo" style="width:60%;">
  </center>
</div>    
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        <div class="icon-square text-bg-light d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
          <svg class="bi" width="1em" height="1em"><use xlink:href="#book"/></svg>
        </div>
        <div>
          <h3 class="fs-2">INSTRUCCIONES</h3>
          <p>El cartel debe ser original y producto de investigación teórica o aplicada. Serán aceptadas todos los trabajos que puedan hacer alguna aportación al conocimiento teórico o práctico en la enseñanza y aplicación de las matemáticas. Así mismo se debe cumplir con los lineamientos que se indican en la elaboración del resumen.</p>
           
          <p>El cartel debe incluir las siguientes secciones:
            <li>1.- Encabezado.</li>
            <li>2.- Resumen.</li>
            ...
            <li>5.- Metodología.</li>
            <li>6.- Resultados</li>
            <li>7.- Discusión y/o conclusiones.</li>
            <li>8.- Índice de referencias (en formato APA).
            Todas las imágenes, figuras, tablas y ecuaciones deberán estar numeradas.</li>
           </p>
           <p>El cartel se deberá subir en el sitio del congreso en formato pdf..</p>  


          <p>El registro de carteles consta de tres procesos:
            <li>El resumen.</li>
            <li>El cartel.</li>
            <li>El vídeo de la exposición del cartel.</li></p>
           <p>El resumen, cartel y el vídeo de exposición de cada cartel requieren ser registrados en el sitio del congreso para ser evaluados por el comité evaluador.</p> 
        </div>
      </div>
      <div class="col d-flex align-items-start">
        <div class="icon-square text-bg-light d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
          <svg class="bi" width="1em" height="1em"><use xlink:href="#checklist"/></svg>
        </div>
        <div>
          <h3 class="fs-2">REQUISITOS</h3>
           <p>El resumen deberá contener:
            <li>A) Título (Máximo 15 palabras).</li>
            <li>B) Categoría.</li>
            <li>C) Contenido (Máximo 300 palabras estructurado de acuerdo a la categoría seleccionada) .</li>
            <li>D) Referencias estilo APA (American Psychological Association).</li>
            <li>E) Nombre del autor (y opcional coautores. Máximo 5 integrantes).</li>
            <li>F) Indicar si requiere constancia de participación.</li>
          </p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        <div class="icon-square text-bg-light d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
          <svg class="bi" width="1em" height="1em"><use xlink:href="#exclamation-octagon"/></svg>
        </div>
        <div>
          <h3 class="fs-2">ACLARACIONES</h3>
          <p>
          <p>Espesificaciones del resumen:</p>
          <p>A) El título deberá reflejar el contenido del cartel.</p>

<p>B) Las categorias en donde los autores podrán registrar sus trabajos relacionados al Proceso de Enseñanza Aprendizaje (PEA) son:</p>
...
<p>Al momento de registrar sus trabajos el ponente seleccionará la categoría que más se adapte a ellos.</p>

<p>C) En el contenido se expondrá una síntesis del tema referido.</p>

<p>D) Es necesario que las citas y referencias incluidas en el documento se encuentren en formato APA.</p>

<p>E) Registro autores y coautores.
Los asistentes al congreso podrán participar como ponentes con un máximo de 5 trabajos ya sea como autor o coautor en las siguientes modalidades:</p>
...
<p>Los asistentes podrán participar como ponentes con un máximo de 3 trabajos en la categoría de Ponencias, con un máximo de 2 Carteles y con un Taller</p>

<p>F) Las constancias son individuales por lo que el autor y coautores que las requieran necesitan realizar la exposición del trabajo y el pago correspondiente.</p>


<li>Se entregará constancia de "Asistencia al congreso", cuando haya participado en las actividades del congreso.</li>
<li>Se entregará constancia de "Presentación de cartel", cuando su resumen, cartel y vídeo hayan sido aceptados por el comité organizador y estos hayan sido presentados en el evento.</li>
<li>Se entregarán constancias de ganadores a los tres primeros lugares que determine el comité evaluador.</li>

<p> Cualquier aspecto o situación no considerada en la presente convocatoria será resuelta por el comité organizador y su desición será inapelable.</p>
