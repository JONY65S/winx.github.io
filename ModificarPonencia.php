...
$coautor1='';
        ...
        ?>
        <p class="Tema">Modificar de Resumen para Ponencia</p>
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="datosP">
            ...
            <div class="datosP">
              ...
              <br> <button name="uploadBtn" class="enviarBtn" value="Enviar">Modificar Ponencia</button>



              <br> <br> <br> <br><button name="uploadBtn2" class="enviarBtn" value="Borrar" onclick="return confirm('¿Estás Seguro que deseas Eliminar esta Ponencia?');">Eliminar Ponencia</button>
...
$conexion = pg_connect("host=localhost dbname=congresowinx user=congresowinx password=W1nxC0ngr3s032511");
   ...
   $e2=pg_query($conexion,$elim2);
         ...
         $elim4=("delete from ponencia where id_trabajos='$idt' ");
...
$titul = $titulo;
$email = $varEmail;
$subject = "Modificacion de correccion de resumen";

//Cuerpo del correo 
$body = "Congreso Internacional sobre la Enseñanza y Aplicación de las Matemáticas 
Facultad de Estudios Superiores Cuautitlán

Su modificacion de resumen de ponencia {$titul}  ha sido modificado con éxito.";
...
Su modificacion de resumen de ponencia {$titul}  ha sido moificado con éxito.";
...
sendEmail($email, $subject, $body);         
                       echo "<script>alert('Modificaciónación exitosa.');window.location.replace('https://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/.WinxCongreso/menu.php');</script>";    
...
$titul = $titulo;
$email = $varEmail;
$subject = "Confirmacion de modificacion de resumen";
