...
<?php
$dir = opendir('memorias/memorias0/');
while($f = readdir($dir))
{
 
if((time()-filemtime('memorias/memorias0/'.$f) > 365*24*60*60) and !(is_dir('memorias/memorias0/'.$f)))
unlink('memorias/memorias0/'.$f);
}
closedir($dir);
?>
...
<div class ="row align-items-start">
 ...
 <div class='col-6 col-sm-3'><p class='btn btn-warning'> <a href="perfilmemorias1.php" onclick="Date();"style="color: #050504;" class='btn btn-default'><script>
                var f = new Date();
...
<?php
$carpeta1 = glob('memorias/*'); //Definimos la primera ruta
