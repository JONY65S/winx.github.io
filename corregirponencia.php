...
<html lang="es">
    <head>
        ...
        <title>Correción de Resumen para Ponencia</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
   ...
   $queryevr2=("Select * from evaluacion_resumen where evaluacion_id='$idev' ");
                  //obtiene el id de su evaluacion
...
$querydt2=("Select * from ponencia where id_trabajos='$idt'");
                  //obtiene el id de su evaluacion
...
$ccoautor = 0;
                                 ...
                                 if (pg_num_rows($connc) > 3) {  //tiene 4 coautores
                                                    while($rowDatac = pg_fetch_array($connc)){
                                                   $ccoautor ++;
                                                   if($ccoautor == 1){
                                                   ...
                                                   if($ccoautor == 3){
                                                        $coautor3id=$rowDatac["coautor_id"];
                                                   }
                                                   if($ccoautor == 4){
                                                        $coautor4id=$rowDatac["coautor_id"];
                                                   }
                                               

                                                    } 
                                              
                                              }elseif (pg_num_rows($connc) > 2) {
                                              while($rowDatac = pg_fetch_array($connc)){ // tiene 3 coautores
                                                     $ccoautor ++;
                                                   if($ccoautor == 1){
                                                        $coautor1id=$rowDatac["coautor_id"];
                                                   }
                                            ...
                                            while($rowDatac = pg_fetch_array($connc)){ //tiene 2 coautores
                                              ...
                                              }elseif (pg_num_rows($connc) > 0) {while($rowDatac = pg_fetch_array($connc)){ //tiene 1 coautor
                                                    $ccoautor ++;
                                                   if($ccoautor == 1){
                                                        $coautor1id=$rowDatac["coautor_id"];
                                                   } 
...
$coautor1='';
            if($coautor4id==0){
             $coautor4=''; 
                 ...
                 $queryco4=("Select * from usuario where id_usuario='$coautor4id'");
                  //obtiene el id de su evaluacion
                            $connco4=pg_query($conexion,$queryco4); 
                     
                                                     if(!$connco4){
                                                        die(pg_error($conexion));
                                                         }

                                               if (pg_num_rows($connco4) > 0) {
                                                    while($rowDatco4 = pg_fetch_array($connco4)){
                                                      $coautor4=$rowDatco4["usuario"];
            ...
            if($coautor3id==0){
             $coautor3=''; 
                 ...
                 $queryco3=("Select * from usuario where id_usuario='$coautor3id'");
                  //obtiene el id de su evaluacion
                            $connco3=pg_query($conexion,$queryco3); 
                     
                                                     if(!$connco3){
                                                        die(pg_error($conexion));
                                                         }

                                               if (pg_num_rows($connco3) > 0) {
                                                    while($rowDatco3 = pg_fetch_array($connco3)){
                                                      $coautor3=$rowDatco3["usuario"];
  ...
  ?>
        <p class="Tema">Correción de Resumen para Ponencia</p>
                        <form method="POST" enctype="multipart/form-data"   >
<p class="temaSec">Antes de llenar cada espacio, favor de leer primero las indicaciones detenidamente. </p> <br><table>

                         <p class="temaSec">Las observaciones acerca de su resumen son las siguientes:</p>   
                        <center>    <tr>
                                <td class="C1">
                                ...
                                <td class="C2">
                                    <textarea class="textarea2" type="text"  name="titulo" style="text-transform:uppercase;" value="<?php echo $idev2 ?>" readonly><?php echo $idev2 ?></textarea>
                            
                                </td>
                                                    </tr> </center>
                        </table>
                <br><p class="temaCentral">Datos</p>
                ...
                <div class="datosP">
                    ...
                    <div class="D1">
                        ...
                        <center>    <tr>
                                ...
                                <td class="C2">
                             <textarea class="textarea2" type="text"  name="titulo" style="text-transform:uppercase;" value="<?php echo $titulo ?>"><?php echo $titulo ?> </textarea>
                    ...
                    <div class="D1">
                        ...
                        <table>
                        	<br><p class="temaSec">5.- Ingrese un correo únicamente por recuadro de texto. Importante: el correo debe estar registrado en el sistema para que el registro de este resumen sea éxitoso.</p>
                                ...
                                <td class="C2">
                                <textarea class="textarea2" type="text"  name="Correo4" placeholder="INGRESA CORREO DEL COAUTOR 3 (OPCIONAL)" value="<?php echo $coautor3 ?>"><?php echo $coautor3 ?></textarea>
                                </td>
                                                    </tr> </center>
                                ...
                                <td class="C2">
                                <textarea class="textarea2" type="text"  name="Correo5" placeholder="INGRESA CORREO DEL COAUTOR 4 (OPCIONAL)" value="<?php echo $coautor4 ?>"><?php echo $coautor4 ?></textarea>
                                </td>
                                                    </tr> </center>
                ...
                <div class="datosP">
                    ...
                    <!--******REFERENCIAS*******-->
                        ...
                        <table>
                            <br><p class="temaSec">6.- Ingrese una bibliografía únicamente por recuadro de texto, a lo más 200 palabras. Importante: el correo debe estar registrado en el sistema para que el registro de este resumen sea éxitoso.</p>
                        <center>    <tr>
                            <td class="C1">
       ...
       <br> <button name= "uploadBtn" class="enviarBtn" value="Enviar">Corregir resumen</button> 
...
if(isset($_POST["titulo"]) && isset($_POST["resumen"]) && isset($_POST["palabrasclave"]) && isset($_POST["categorias"]) && isset($_POST["Correo1"])  &&isset($_POST["bibliografia"])  && isset($_POST["Correo2"]) && isset($_POST["Correo3"]) && isset($_POST["Correo4"]) && isset($_POST["Correo5"]) ) {  
...
if($Correo2 != ""){
 ...
 $query5=("UPDATE trabajos set titulo='$titulo', categoria='$categoria', palabras_clave='$palabrasclave', fecha_trabajos='$fechaActual', hora_trabajos='$horaActual' where id_trabajo='$idt'");
                ...
                $query7=("UPDATE ponencia SET   resumen_ponencia='$resumen'  WHERE id_trabajos='$idt'");
                       ...
                       if($coautor1id==$idcoautor2){
                        ...
                        $consulta42=pg_query($conexion,$query92);
                          ...
                          $consulta5=pg_query($conexion,$query10);}
                                            ...
                                            //si modifico el coautor 3 
                       if($coautor3id==$idcoautor4){

                       }else{   

                               if ($coautor3id==0) {

                                           $query93=("INSERT INTO trabajos_coautores (trabajos_id, coautor_id)
                          VALUES('$idt','$idcoautor4')");
                        $consulta43=pg_query($conexion,$query93);


                                               }else{ 
                                $query11=("UPDATE trabajos_coautores set coautor_id='$idcoautor4' WHERE trabajos_id='$idt' and coautor_id='$coautor3id' ");
                               $consulta6=pg_query($conexion,$query11);}
                       }
                                 


                                       //si modifico el coautor 4 
                       if($coautor4id==$idcoautor5){

                       }else{  

                               if ($coautor4id== 0) {

                                           $query94=("INSERT INTO trabajos_coautores (trabajos_id, coautor_id)
                          VALUES('$idt','$idcoautor5')");
                        $consulta44=pg_query($conexion,$query94);


                                               }else{ 

                             $query12=("UPDATE trabajos_coautores set coautor_id='$idcoautor5' WHERE trabajos_id='$idt' and coautor_id='$coautor4id' ");
...
$titul = $titulo;
$email = $varEmail;
$subject = "Confirmacion de correccion de resumen";

//Cuerpo del correo 
$body = "Congreso Internacional sobre la Enseñanza y Aplicación de las Matemáticas 
Facultad de Estudios Superiores Cuautitlán

Su corrección de resumen de ponencia {$titul}  ha sido corregido con éxito.";

sendEmail($email, $subject, $body);         
                       echo "<script>alert('Corrección exitosa.');window.location.replace('https://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/.WinxCongreso/menu.php');</script>"; 
                       ...
                       if($coautor3id==$idcoautor4){
                        ...
                        $consulta43=pg_query($conexion,$query93);
                          ...
                          if($coautor4id==0){
                                 ...
                                 $query924=("DELETE FROM trabajos_coautores where trabajos_id='$idt' and  coautor_id='$coautor4id'");
                        $consulta424=pg_query($conexion,$query924); 
...
$query5=("UPDATE trabajos set titulo='$titulo', categoria='$categoria', palabras_clave='$palabrasclave', fecha_trabajos='$fechaActual', hora_trabajos='$horaActual' where id_trabajo='$idt'");
           ...
           if($coautor3id==0){
                                 ...
                                 $query923=("DELETE FROM trabajos_coautores where trabajos_id='$idt' and  coautor_id='$coautor3id'");
                        $consulta423=pg_query($conexion,$query923); 
                  ...
                  //coautor 2
                     $query41=("Select * from coautor where id_coautor='$idcoautor2' ");
                       ...
                       if($coautor2id==0){
                                 ...
                                 $query922=("DELETE FROM trabajos_coautores where trabajos_id='$idt' and  coautor_id='$coautor2id'");
                        $consulta422=pg_query($conexion,$query922); 
               ...
               //ACTUALIZA DATOS DEL TRABAJO
                ...
                $query7=("UPDATE ponencia SET resumen_ponencia='$resumen'  WHERE id_trabajos='$idt'");
                        ...
                        if($coautor1id==0){
                         ...
                         $query921=("DELETE FROM trabajos_coautores where trabajos_id='$idt' and  coautor_id='$coautor1id'");
                        $consulta421=pg_query($conexion,$query921); 
