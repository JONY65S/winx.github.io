...
if (pg_num_rows($consultaT1) > 0) {
    ...
    $queryT2=("select * from evaluacion_cartel where evaluacion_id='$idevr'"); 
...
Su corrección de imagen de cartel {$titul} ha sido registrada con éxito.";
...
<html lang="es">
    <head>
        ...
        <title>Correción de Cartel</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
   ...
   $queryevr2=("Select * from evaluacion_cartel where evaluacion_id='$idev' ");
                  //obtiene el id de su evaluacion
  ...
  ?>
        <p class="Tema">Corrección de Cartel</p>
                        <form  method="POST" enctype="multipart/form-data"   >
<table>

                         <p class="temaSec">Las observaciones acerca de su cartel son las siguientes:</p>   
                        <center>    <tr>
                                <td class="C1">
...
<div class="D1">
  ...
  <table>
             ...
             <button class="enviarBtn" type="submit" name="subir" value="Cargar archivo">Enviar corrección</button><br>
