    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                <p class="Tema">Extenso a evaluar</p>  
                <form method="post" action="evaExtB.php">
                   <?php
                    ...
                    <div class="datosP">
                        <div class="D1">
                            <table>
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">1. Plantilla</label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">2. Formato </label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">4. Referencias APA </label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">5. Referencias Citadas </label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">6. Redacción </label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">7. Presentación </label>
                                    </td>
                                    <td class="C5">
