...
<?php
    ...
    if($aspE0 == $Comp and $aspE1 == $Comp and $aspE2 == $Comp and $aspE3 == $Comp){
        ...
        class PDF extends FPDF
        {
            ...
            function Header() 
            {
                ...
                $this->Text(10,95,utf8_decode('Tenemos el agrado de comunicarle (s) que su Video del Cartel:'));
                ...
                $this->Text(10,130,utf8_decode('1 - Consultar los lineamientos de presentación del cártel.'));
    ...
    $filePdf = $file;
    $pdfName = "VC_" . $workId . $fechaid . ".pdf";
