...
<div class='col-6 col-sm-3'><p class='btn btn-warning'> <a href="memoriascarruselSesion1.php" onclick="Date();"style="color: #050504;" class='btn btn-default'><script>
                var f = new Date();
                document.write( f.getFullYear()-1);
                      </script></a></div>";

<div class='col-6 col-sm-6'><p class='btn btn-warning'> <a href="memoriascarruselSesion2.php" onclick="Date();" style="color: #050504;" class='btn btn-default'>  <script>
                var f = new Date();
                document.write( f.getFullYear()-2);
                      </script></a></div>";

<div class='col'><p class='btn btn-warning'> <a href="memoriascarruselSesion3.php" onclick="Date();" style="color: #050504;" class='btn btn-default'>  <script>
                var f = new Date();
 ...
 <div class="contenedoramarillo">
  ...
  <main class="gallery">
        ...
        <?php
     $fotos  = scandir('memorias/memorias0');
       foreach ($fotos as $foto) 
        ...
        if (str_contains($foto, '.jpg') || str_contains($foto, '.jpeg') || str_contains($foto, '.png')) {
            ...
            <a href= \"memorias/memorias0/" . $foto . " \"> <img class=\"zoom\"src= \"memorias/memorias0/" . $foto . " \" /></a>
...
<div class="container">
<?php
    $videos  = scandir('memorias/memorias0');
    foreach ($videos as $video) {

       if (str_contains($video, 'mp4')) {
               $htmlVideo = "<div class=\"videos\"><video src=\"memorias/memorias0/" . $video . "\" muted autoplay loop></video></div>";
                echo $htmlVideo;
            }
