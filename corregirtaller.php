...
<html lang="es">
    <head>
        ...
        <title>Correción de Resumen para Taller</title>
       <meta charset="UTF-8">  
...
$coautor1='';
  ...
  ?>
        <p class="Tema">Correción de Resumen para Taller</p>
...
<p class="temaSec">Antes de llenar cada espacio, favor de leer primero las indicaciones detenidamente. </p> <br><table>
                        ...
                        <center>    <tr>
                                ...
                                <td class="C2">
                                    <textarea class="textarea2" type="text"  name="titulo" value="<?php echo $idev2 ?>" readonly><?php echo $idev2 ?></textarea>
...
Su corrección de resumen de taller {$titul}  ha sido registrada con éxito.";
