...
<div class='col-6 col-sm-3'><p class='btn btn-warning'> <a href="memoriascarruselSesion.php" onclick="Date();"style="color: #050504;" class='btn btn-default'><script>
                var f = new Date();
                document.write( f.getFullYear());
                      </script></a></div>";

<div class='col-6 col-sm-6'><p class='btn btn-warning'> <a href="memoriascarruselSesion1.php" onclick="Date();" style="color: #050504;" class='btn btn-default'>  <script>
                var f = new Date();
...
<div class='col'><p class='btn btn-warning'> <a href="memoriascarruselSesion3.php" onclick="Date();" style="color: #050504;" class='btn btn-default'>  <script>
 ...
 <div class="contenedoramarillo">
  ...
  <main class="gallery">
        ...
        <?php
     $fotos  = scandir('memorias/memorias2');
       foreach ($fotos as $foto) 
        ...
        if (str_contains($foto, '.jpg') || str_contains($foto, '.jpeg') || str_contains($foto, '.png')) {
            ...
            <a href= \"memorias/memorias2/" . $foto . " \"> <img class=\"zoom\"src= \"memorias/memorias2/" . $foto . " \" /></a>
