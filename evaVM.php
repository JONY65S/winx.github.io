    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                <p class="Tema">Evaluación de videos</p>
                <p class="temaCentral">Seleccione el tipo de trabajo a evaluar.</p>
                <div class="datosP">
                    <div class="D1">
                        <div>
                            <center>
                                <button type="submit" onclick="window.location.href = 'evaVid.php'">Ponencia</button>
                                <button type="submit" onclick="window.location.href = 'evaVi.php'">Cártel</button>
                            </center>
                        </div>
                    </div>
                </div>
