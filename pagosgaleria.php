...
<link rel="icon" href="img/favicon.png" type="image/x-icon">
      ...
      .gallery_item{
        clip-path: path(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%);
        grid-column: span 2;
        height: 238px;
...
Encabezado de la página */
 ...
 <div class="contenedoramarillo">
   ...
   <div> <main class="gallery">
        <?php
     $fotos  = scandir('Pagos/Pagos2023');
       foreach ($fotos as $foto) 
        ...
        if (str_contains($foto, '.jpg') || str_contains($foto, '.jpeg') || str_contains($foto, '.png')) {
            ...
            <a href= \"Pagos/Pagos2023/" . $foto . " \"> <img class=\"zoom\"src= \"Pagos/Pagos2023/" . $foto . " \" /></a>
...
<br><br><br>
 <center> <a href="menu.php"> <button>Regresar</button> </a>  </center><br><br>
</div> 
  <br>
