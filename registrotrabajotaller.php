...
$query3 = ("INSERT INTO materiales (id_material, nombre_material) VALUES ('$numid','$materiales')");
...
$query5 = ("INSERT INTO talleres_material (taller_id, material_id) VALUES ('$idtt','$numid')");
$consulta3=pg_query($conexion,$query5); //ejecuta la acción query en la BD
...
$queryNewT1=pg_fetch_array($consultaT1);
$idevr=$queryNewT1["evaluacion_id"];

$queryT2=("select * from evaluacion where  id_evaluacion='$idevr'"); 
$consultaT2=pg_query($conexion,$queryT2); 
$queryNewT2=pg_fetch_array($consultaT2);
$idevaluador=$queryNewT2["usuario_id"];

//Estado de la evaluacion
             $queryE1=("UPDATE evaluacion_trabajos SET estado='ACEPTADO' WHERE trabajos_id='$idtt' and evaluacion_id='$idevr'");
        $consultaE1=pg_query($conexion,$queryE1); 

        $queryA2 = ("INSERT INTO evaluacion (fecha, usuario_id, id_evaluacion) VALUES ('$fechaActual','$idevaluador','$numid')");
                  $connA2 = pg_query($conexion, $queryA2);
     if (!$connA2) {
                    die(pg_error($conexion));
                  }else{
$queryA4 = ("INSERT INTO evaluacion_taller  values ('$numid' )");
                  $connA4 = pg_query($conexion, $queryA4);

$queryA3 = ("INSERT INTO  evaluacion_trabajos ( evaluacion_id, trabajos_id,  fecha,     estado) values('$numid','$idtt','$fechaActual','POR EVALUAR')");
...
$titul = $queryTitulo;
$email = $varEmail;
$subject = "Confirmacion de registro de trabajo";

//Cuerpo del correo
$body = "Congreso Internacional sobre la Enseñanza y Aplicación de las Matemáticas 
Facultad de Estudios Superiores Cuautitlán

Su contenido y materiales del taller {$titul} han sido registrados con éxito."; 
...
<html lang="es">
    <head>
        ...
        <title>Registro de Contenido y Materiales para Taller</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de Contenido y Materiales para Taller</p>
  ...
  <table>
                        ...
                        <center> <tr>
                               <tr> <p class="temaSec">1.- Ingresa el contenido de tu taller.</p> </tr> <td class="C1">
                                ...
                                <td class="C2">
                               <br><textarea class="textarea2"  type="text"  name="contenido" placeholder="INGRESA EL CONTENIDO DEL TALLER" style="text-transform:uppercase;" required></textarea> 
                                </td>
                                                    </tr> </center>
                   ...
                   <div class="D1">
                        ...
                        <table>
                            ...
                            <center>    <tr>
                                ...
                                <td class="C2">
                                    <textarea class="textarea2" type="text" name="materiales" placeholder="INGRESA LOS MATERIALES PARA EL TALLER" style="text-transform:uppercase;"required></textarea>
