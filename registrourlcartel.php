...
//Query que actualiza la tabla, agregando el dato de video y extenso
 $idtt=$_GET['itt'];
$query2 = ("UPDATE carteles SET video_url = '$url' WHERE id_trabajos = '$idtt'"); //el numerito es el id de una ponencia
...
Su URL del video de cartel {$titul} ha sido registrada con éxito.";
...
<html lang="es">
    <head>
        ...
        <title>Registro de Video para Cartel</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de URL de Video para Cartel</p>
