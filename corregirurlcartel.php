...
Su corrección de URL de cartel {$titul} ha sido registrada con éxito.";
...
<html lang="es">
    <head>
        ...
        <title>Corrección de Video para Cartel</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 $queryurl=("Select * from carteles where id_trabajos='$idt' ");
                  //obtiene el id de su evaluacion
  ...
  ?>
        <p class="Tema">Corrección de Video para Cartel </p>
