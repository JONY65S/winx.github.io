 ...
 $queryc13=("Select * from congreso ");
                            $connc6=pg_query($conexion,$queryc13);
                               ...
                               if (pg_num_rows($connc6) > 0) {
                                       ...
                                       $nponencia=intval($rowData["num_talleres"]);
   ...
   $queryC1=("Select * from ponente_trabajos where ponente_id='$varId'");
                            ...
                            $connC2=pg_query($conexion,$queryC2);
                                        ...
                                        //contador de trabajos por congreso actual
                                           ...
                                           $queryP1=("Select * from talleres where id_trabajos='$idt2'");
                           ...
                           //evalua si al final se ha subido 3 o mas trabajos, de ser asi no permite registrar y manda al menu.
                                                        if($conta2>=$nponencia){
                                                         ...
                                                         echo "<script>alert('Ha sobrepasado el limite de registro de talleres permitidos.');window.location.replace('https://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/.WinxCongreso/menu.php');</script>";                               
                                                          }}
...
<html lang="es">
    <head>
        ...
        <title>Registro de Resumen para Paller</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de resumen para taller</p>
...
if(isset($_POST["titulo"]) && isset($_POST["resumen"]) && isset($_POST["palabrasclave"])&& isset($_POST["bibliografia"]) && isset($_POST["categorias"]) && isset($_POST["Correo1"]) && isset($_POST["Correo2"]) && isset($_POST["Correo3"])) {  
       ...
       if( $Correo5 != ""){
                ...
                $query7=("INSERT INTO talleres (id_trabajos, resumen_ponencia)
...
Su resumen de taller {$titul} ha sido registrado con éxito.";
