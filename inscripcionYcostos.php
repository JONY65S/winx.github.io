<html lang="es">
    <head>
        ...
        <title>Inscripcion y costos del congreso</title>
       <meta charset="UTF-8"> 
...
<div class="ContenedorPrincipal"> 
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    ...
    <p class="Tema">Inscripción y Costos</p>
    ...
    <div class="datosP" >
        ...
        <table>
          <center>
            ...
            <div class="photo">
             ...
             <p class="temaSec">Nota: Estudiantes de licenciatura o media superior, únicamente pueden participar como
              asistentes y con derecho a un taller o curso.</p>
            </tr>
          </center>
        </table>
      </div>
   
      <p class="temaCentral">FORMAS DE PAGO</p>
      <div class="datosP">
        <div class="D1">
          <table>
            <center>
              <tr>
                <p class="temaSec">A partir del 10 de marzo de 2023, se podrá realizar el pago de la inscripción de
      ...
      <p class="temaCentral">A) Efectivo</p>
      <div class="datosP">
        <div class="D1">
          <table>
            <center>
              <tr>
                <p class="temaSec">Cajas de Campo 4 ubicadas en la FES-Cuautitlan bajo el concepto de Decimoquinto Congreso Internacional sobre la Enseñanza y Aplicación de las Matemáticas.</p>
                <p class="temaSec"> Descargar la plantilla para pagos en cajas</p>
      ...
      <p class="temaCentral">B) Bancario</p>
      <div class="datosP">
        <div class="D1">
          <table>
            <center>
              <tr>
                <p class="temaSec">1. Solicitar al correo altamira@unam.mx una ficha referenciada bancaria.</p>
                <p class="temaSec">2. Pagar en el banco.</p>
                <p class="temaSec">3. Escanear el pago y enviar la imagen con el sello de pago legible al mismo correo.</p>
              </tr>
            </center>
          </table>
        </div>
      </div>
      <p class="temaCentral">FACTURACIÓN</p>
      <div class="datosP">
        <div class="D1">
          <table>
            <center>
              <tr>
                <p class="temaSec">A) En caso de requerir factura enviar al correo altamira@unam.mx el comprobante de pago escaneado y sus datos fiscales completos.</p>
                <p class="temaSec">B) Si no requiere factura favor de enviar solamente el comprobante de pago escaneado con su nombre completo para registrar el pago al correo mencionado en el parrafo anterior. </p>
                <p class="temaSec"><br>Nota: Solo se facturará en el mes en que se realizó el pago.</p>
              </tr>
            </center>
          </table>
        </div>
