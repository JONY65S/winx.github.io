...
<div class ="row align-items-start">
  ...
  <div class='col-6 col-sm-3'><p class='btn btn-warning'> <a href="memoriascarrusel1.php" onclick="Date();"style="color: #050504;" class='btn btn-default'><script>
                var f = new Date();
                document.write( f.getFullYear()-1);
                      </script></a></div>";

<div class='col-6 col-sm-6'><p class='btn btn-warning'> <a href="memoriascarrusel2.php" onclick="Date();" style="color: #050504;" class='btn btn-default'>  <script>
                var f = new Date();
                document.write( f.getFullYear()-2);
                      </script></a></div>";

<div class='col'><p class='btn btn-warning'> <a href="memoriascarrusel3.php" onclick="Date();" style="color: #050504;" class='btn btn-default'>  <script>
                var f = new Date();
