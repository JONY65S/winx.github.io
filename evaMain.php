    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                <p class="Tema">Evaluación de resumen</p>
                <p class="temaCentral">Seleccione el tipo de trabajo a evaluar.</p>
                <div class="datosP">
                    <div class="D1">
                        <div>
                            <center>
                                <button type="submit" onclick="window.location.href = 'evaResP.php'">Ponencia</button>
                                <button type="submit" onclick="window.location.href = 'evaResC.php'">Cártel</button>
                                <button type="submit" onclick="window.location.href = 'evaResT.php'">Taller</button>
                            </center>
                        </div>
                    </div>
                </div>
