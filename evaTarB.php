<meta HTTP-EQUIV="REFRESH" CONTENT="0;URL=evaTar.php">
<?php
    ...
    $aspE2 = $_POST['aspEva2'];
    $aspE3 = $_POST['aspEva3'];
    $queryC0=("UPDATE evaluacion_taller SET titulo='$aspE0', contenido='$aspE1', materiales='$aspE2', observaciones='$aspE3' WHERE evaluacion_id='$evaId'");
    ...
    if($aspE0 == $Comp and $aspE1 == $Comp and $aspE2 == $Comp){
        $Final = 'AUTORIZADA'; 
        ...
        class PDF extends FPDF
        {
            ...
            function Header() 
            {
                ...
                $this->Text(10,95,utf8_decode('Tenemos el agrado de comunicarle (s) que su Contenido de taller:'));
                ...
                $this->Text(10,145,utf8_decode('2 - Por favor estar atento al cronograma del evento.'));
    ...
    $filePdf = $file;
    $pdfName = "CT_" . $workId . $fechaid . ".pdf";
...
<script>
    ...
    alert("EL CONTENIDO " + varTit + " A SIDO " + varFin + " ¡GRACIAS POR EVALUAR!");
</script>