...
<html lang="es">
    <head>
        ...
        <title>Agregar Mesa Redonda</title>
       <meta charset="UTF-8"> 
...
<div class="contenedorregistroI"> 
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    ...
    <p class="Tema">Agregar Mesa Redonda</p>
 ...
 <div class="D1">
                   ...
                   <tr>
                                <td class="C1">
                                     ...
                                     <label for="Palabras">Categoria de la mesa:</label>
 ...
 <br>
  ...
  <div class="D1">
            ...
            <td class="C2">
                                    <!--<input class="inputP" style="text-transform:uppercase;" type="text" name="categoria" placeholder="Ingresa categoria" required> -->
                                                                  ...
                                                                  <select border-radius: 9px; input class="inputNombreC" name ="tipo">
                                                                        ...
                                                                        <option ><a onClick="return ico1()">VIRTUAL</a></option>
                                                                    </select>
                                                                </td>
          ...
          <label for="Link">Link (en caso de ser virtual):</label>
            ...
            <td class="C2">
          <input class="inputNombreC" type="text" name="link" placeholder="Ingresa el link de la mesa en el caso de que sea virtual" >
                </td>
