  ...
  <div class="ContenedorPrincipal">
    <div class="px-4 pt-5 my-5 text-center border-bottom">
      ...
      <div class="col-lg-6 mx-auto">
        ...
        <p class="Tema">Modificar de Resumen para Cartel</p>
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="datosP">
            ...
            <div class="datosP">
              ...
              <br> <button name="uploadBtn" class="enviarBtn" value="Enviar">Modificar Cartel</button>



              <br> <br> <br> <br><button name="uploadBtn2" class="enviarBtn" value="Borrar" onclick="return confirm('¿Estás Seguro que deseas Eliminar este Cartel?');">Eliminar Cartel</button>
...
La modificación del resumen para el cartel {$titul}  ha sido realizado con éxito.";
...
//Corchetes que cierran el if del boton y del post
        ...
        if (isset($_POST['uploadBtn2']) && $_POST['uploadBtn2'] == 'Borrar') {
          ...
          $elim4 = ("delete from carteles where id_trabajos='$idt' ");
