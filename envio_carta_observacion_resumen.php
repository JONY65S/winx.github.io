...
$mail->Subject = "Evaluación resumen de ponencia oral";
//$mail->AltBody = "Te confirmamos que hemos recibido tu resumen ";

//mensaje en html 
$mail->MsgHTML("Le informamos que el Comité Evaluador ha evaluado el resumen de su propuesta de ponencia oral <br> 
            ...
            corregir en su trabajo, para ser sometido a una nueva evaluación y pueda subirlo nuevamente.");
//direccion de envio
...
if(!$mail->Send()) {
  ...
  echo "<br>Se ha enviado un correo al autor informándole del resultado de la evaluación de su resumen.<br>";
}
