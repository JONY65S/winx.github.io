...
<div class="contenedorPrincipal"> 
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    <div class="col-lg-6 mx-auto"> 
      <!--<form  method="post"> -->
     <p class="Tema">Estado de Taller</p>  <form action="#" method="POST" >
     <div class="D1">  
     <?php
               ...
               <tr>                                         
                ...
                <td >
                  <?php
                         ...
                         ?> 
                               <a href="corregirtaller.php?itt=<?php echo $rowDataEvaResP3["trabajos_id"];?>">
                 ...
                 <br> <br> <br>
                   ...
                   $querycondi = ("Select * from talleres WHERE id_trabajos='$id_pon'");
                ...
                $condi2= $rowDatacondi["contenido"];}}

                             if($condi2==''){

                              ?>

                       <a href="registrotrabajotaller.php?itt=<?php echo $rowDataEvaResP3["trabajos_id"];?>">
                        
                  <button type="button" >Enviar Contenido del Taller</button> </a> 
                    <?php
                             }}
                  ?>
               </td>
         ...
         <p class="temaCentral">Taller </p>
            ...
            <?php
              ...
              ?>
               ...
               <tr>                                         
								<td class="C1">
									<label >Estado Actual de la Evaluación del Taller:</label>
								</td>
								<td class="C2">
                ...
                <td >
                  <?php
                         ...
                         ?> 
                               <a href="corregirtrabajotaller.php?itt=<?php echo $rowDataEvaExP3["trabajos_id"];?>">
                        
                  <button type="button" >Corregir Contenido del Taller</button> </a>
                 <br> <br> <br>
