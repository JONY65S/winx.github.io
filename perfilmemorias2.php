...
<?php
$dir = opendir('memorias/memorias2/');
while($f = readdir($dir))
{
 
if((time()-filemtime('memorias/memorias2/'.$f) > 365*24*60*60) and !(is_dir('memorias/memorias2/'.$f)))
unlink('memorias/memorias2/'.$f);
}
closedir($dir);
?>
...
$listar = null;
$directorio=opendir("memorias/memorias2/");
...
$folder = "memorias/memorias2/";
move_uploaded_file($_FILES["formato"]["tmp_name"] , "$folder".$_FILES["formato"]["name"]);
echo "<div class='alert alert-success'><p class='hidd' align=center>El archivo  ".$_FILES["formato"]["name"]." se ha cargado correctamente. <a href='perfilmemorias2.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
  }
...
@unlink('memorias/memorias2/'.$borrarFor);
echo "<div class='alert alert-danger'><p class='hidd' align=center>El archivo  ".$borrarFor." ha sido eliminado correctamente. <a href='perfilmemorias2.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
}
?>
