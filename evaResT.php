    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                ...
                <form name="first" method="post" id='forms1' action="evaResFT.php">
                                    ...
                                    <td class="C4">
                                        <p align="left">Trabajo: 
                                            <select name="workUser" onchange='submitForm();'>
                                                ...
                                                <?php
                                                $query=("SELECT * FROM trabajos, evaluacion_trabajos, evaluacion, talleres WHERE trabajos.id_trabajo=evaluacion_trabajos.trabajos_id and evaluacion_trabajos.evaluacion_id=evaluacion.id_evaluacion and talleres.id_trabajos=trabajos.id_trabajo and evaluacion_trabajos.estado='POR EVALUAR' and resumen_ponencia LIKE '%' and contenido IS NULL and usuario_id='$varId'");
