    ...
    <div class="contenedorregistroI">
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <div class="col-lg-6 mx-auto justify-content: center;">
                <p class="Tema">Cártel a evaluar</p>  
                <form method="post" action="evaCarB.php">
                   <?php
                        ...
                        $queryFileDwl=$queryNew2["cartel_jpg"];  
                    
                        $query4=("select * from evaluacion_trabajos, evaluacion where evaluacion_id=id_evaluacion and evaluacion_trabajos.estado='POR EVALUAR' and trabajos_id='$workUserId'");
                        $consulta4=pg_query($conexion,$query4);
                        $queryNew4=pg_fetch_array($consulta4);
                        $queryEvaId=$queryNew4["evaluacion_id"]; 
                    
                        $query5=("INSERT INTO evaluacion_cartel (evaluacion_id) values ('$queryEvaId')");
                        $consulta5=pg_query($conexion,$query5);
                        
                        $rutaFile='./Registrotrabajos/cartelesimagenes/'.$queryFileDwl;
                    
                        $query85=("select * from evaluacion_cartel where evaluacion_id=$queryEvaId");
                                    ...
                                    <tr>
                                       <td class="C1">
                                        ...
                                        <td colspan="2" align="center">
                                           <a href="<?php echo $rutaFile ?>" class="a65" target="_blank">
                                               VER CÁRTEL
                                           </a> 
                                        </td>
                                    </tr>
                    ...
                    <div class="datosP">
                        <div class="D1">
                            <table>
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">1. Encabezado. </label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">2. Introducción.</label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">3. Metodología.</label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">4. Resultados. </label>
                                    </td>
                                    <td class="C5">
                                ...
                                <tr>
                                    <td class="C3">
                                        <label for="Name">5. Conclusiones.</label>
                                    </td>
                                    <td class="C5">
                                        <input type="radio" name="aspEva4" value="true" required>
                                    </td>
                                    <td class="C5">
                                        <input type="radio" name="aspEva4" value="false" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="C3">
                                        <label for="Name">6. Imágenes. </label>
                                    </td>
                                    <td class="C5">
                                        <input type="radio" name="aspEva5" value="true" required>
                                    </td>
                                    <td class="C5">
                                        <input type="radio" name="aspEva5" value="false" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="C3">
                                        <label for="Name">7. Cártel en formato JPG.</label>
                                    </td>
                                    <td class="C5">
                                        <input type="radio" name="aspEva6" value="true" required>
                                    </td>
                                    <td class="C5">
                                        <input type="radio" name="aspEva6" value="false" required>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table>
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="C2">
                                        <textarea class="textarea4" type="text" style="text-transform:uppercase;" name="aspEva7"></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
