...
//Estado de la evaluacion
     ...
     if (!$connA2) {
                    ...
                    $queryA4 = ("INSERT INTO evaluacion_extenso values ('$numid')");
...
Su extenso de ponencia {$titul} ha sido registrado con éxito.";
...
<html lang="es">
    <head>
        ...
        <title>Registro de Extenso</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de Extenso</p>
...
<div class="D1">
  ...
  <table>
                        ...
                        <center> <tr>
                               <tr> <p class="temaSec">1.- Subir el documento del extenso en archivo Word siguiendo los requisitos que plantea la plantilla para los extensos.</p> </tr> <td class="C1">
             ...
             <br><button class="enviarBtn" type="submit" name="subir" value="Cargar archivo">Enviar extenso</button><br>
