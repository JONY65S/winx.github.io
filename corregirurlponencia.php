...
if (pg_num_rows($consultaT1) > 0) {
    ...
    $queryT2=("select * from evaluacion_video where evaluacion_id='$idevr'"); 
...
Su corrección de URL del video de ponencia {$titul} ha sido registrada con éxito.";

sendEmail($email, $subject, $body);  
echo "<script>alert('Corrección de ponencia exitosa.');window.location.replace('https://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/.WinxCongreso/menu.php');</script>";
...
<html lang="es">
    <head>
        ...
        <title>Correción de Video para Ponencia</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
   ...
   $queryevr2=("Select * from evaluacion_video where evaluacion_id='$idev' ");
                  //obtiene el id de su evaluacion
 ...
 $queryurl=("Select * from ponencia where id_trabajos='$idt' ");
                  //obtiene el id de su evaluacion
                            $conneurl=pg_query($conexion,$queryurl); 
                                               ...
                                               if (pg_num_rows($conneurl) > 0) {
                                                    while($rowData1 = pg_fetch_array($conneurl)){
                                                      $urlp=$rowData1["video_url"];}}

  ?>
        <p class="Tema">Correción de Video para Ponencia</p>
                        <form  method="POST" enctype="multipart/form-data"   >

              <table>

                         <p class="temaSec">Las observaciones acerca de su video son las siguientes:</p>   
                        <center>    <tr>
                                <td class="C1">
...
<div class="D1">
  ...
  <table>
                         <td class="C1">
                          ...
                          Drive.</p> 
                                	<textarea class="textarea2"  type="text"  name="url" placeholder="INGRESA URL DEL VIDEO" required><?php echo $urlp ?></textarea>
                                </td>
                                                    </tr> </center>
