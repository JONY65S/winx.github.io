...
<html lang="es">
    <head>
        ...
        <title>Correción de Resumen para Cartel</title>
       <meta charset="UTF-8">  
...
$querydt2=("Select * from carteles where id_trabajos='$idt'");
                  //obtiene el id de su evaluacion
...
$ccoautor = 0;
                                 ...
                                 if (pg_num_rows($connc) > 1) {while($rowDatac = pg_fetch_array($connc)){ //tiene 2 coautores
                                                     $ccoautor ++;
                                                   if($ccoautor == 1){
...
$coautor1='';
  ...
  ?>
        <p class="Tema">Correción de Resumen para Cartel</p>
...
$query5=("UPDATE trabajos set titulo='$titulo', categoria='$categoria', palabras_clave='$palabrasclave', fecha_trabajos='$fechaActual', hora_trabajos='$horaActual' where id_trabajo='$idt'");
                ...
                $query7=("UPDATE carteles SET   resumen_ponencia='$resumen'  WHERE id_trabajos='$idt'");
                  ...
                  //coautor 2
                     $query41=("Select * from coautor where id_coautor='$idcoautor2' ");
                       ...
                       if($coautor1id==$idcoautor2){
                               ...
                               if ($coautor1id==0) {$query91=("INSERT INTO trabajos_coautores (trabajos_id, coautor_id)
                          VALUES('$idt','$idcoautor2')");
                        $consulta41=pg_query($conexion,$query91); 
                                             }else{ $query9=("UPDATE trabajos_coautores set coautor_id='$idcoautor2' WHERE trabajos_id='$idt' and coautor_id='$coautor1id' ");
                        $consulta4=pg_query($conexion,$query9);
                            }
                       }
