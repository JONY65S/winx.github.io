<meta HTTP-EQUIV="REFRESH" CONTENT="0;URL=evaMain.php">
<?php
    ...
    $aspE3 = $_POST['aspEva3'];
    $aspE4 = $_POST['aspEva4'];
    $queryC0=("UPDATE evaluacion_resumen SET titulo='$aspE0', categoria='$aspE1', contenido='$aspE2', referencias='$aspE3', observaciones='$aspE4' WHERE evaluacion_id='$evaId'");
    ...
    if($aspE0 == $Comp and $aspE1 == $Comp and $aspE2 == $Comp and $aspE3 == $Comp){
        ...
        class PDF extends FPDF
        {
            ...
            function Header() 
            {
                ...
                $this->Text(10,95,utf8_decode('Tenemos el agrado de comunicarle (s) que su Resumen de la ponencia:'));
                ...
                $this->Text(10,140,utf8_decode('2 - Subir su extenso en el apartado Historial de trabajos.'));
                $this->Text(10,145,utf8_decode('3 - Crear un vídeo del extenso, máximo de 5 minutos en formato mp4.'));
                $this->Text(10,150,utf8_decode('4 - Subir su video en el apartado Historial de trabajos.'));
                $this->Text(10,155,utf8_decode('5 - Por favor estar atento al cronograma del evento.'));
    ...
    $filePdf = $file;
    $pdfName = "PR_" . $workId . $fechaid . ".pdf";
...
<script>
    ...
    alert("EL RESUMEN " + varTit + " A SIDO " + varFin + " ¡GRACIAS POR EVALUAR!");
</script>